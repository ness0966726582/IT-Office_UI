def __New_GUI__():
    ...
    btn_table1 = [
                ['Name'  ,'X' , 'Y' , 'W' , 'H', 'Path'],
                ['資產自動化上傳\nFAF-Update'   ,'50', '50', '20', '2', r'.\API\1\FAF.exe'],
                ['借用自動化上傳\nBORROW-Update','50', '100', '20', '2', r'.\API\2\Borrow.exe'],
                ['公告自動化上傳\nMEMO-Update'  ,'50', '150', '20', '2', r'.\API\3\Memo.exe'],
                
                ['需求單&附件\nITR & Attachment ','250', '50', '20', '2', r'\\10.231.250.70\Department\Form\HO-ITD'],
                ['SNMP環控','625', '100', '20', '2', r'.\API\Project-SNMP'],
                ['CSV自動化上傳','625', '150', '20', '2', r'.\API\Project-CSV']
                ]   
    btn_table2 = [
                ['Name'  ,'X' , 'Y' , 'W' , 'H', 'Path'],
                ['需求單&附件\nITR & Attachment ','250', '50', '20', '2', r'\\10.231.250.70\Department\Form\HO-ITD'],
    ...
    btn_table3 = [
                ['Name'  ,'X' , 'Y' , 'W' , 'H', 'Path'],               
                ['SNMP環控','625', '50', '20', '2', r'.\API\Project-SNMP'],
                ['CSV自動化上傳','625', '100', '20', '2', r'.\API\Project-CSV'],
                ['IoT環境監測'  ,'625', '150', '20', '2', r'.\API\Project-IoT']
                ]               
## btn_table1
    def __b1_1__():
        Var=1

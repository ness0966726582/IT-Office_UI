...
#--------固定不變--------#
dirPath = r"\\10.231.250.70\Department\InformationTechnology\Auditing\09. FAF\NEW"   #照片存放路徑 
...
def Sendsheet():
    ...
    sheet = client.open_by_key("1z10OoKJqZUBp4s97PVBXCxb0II5wWi8DGcKzpt__Swc").worksheet('Files Check')#指定googlesheet
    ###################################
    #             寫入方式             #
    ###################################
